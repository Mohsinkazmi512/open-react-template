        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              “Learning Enhanced – Spark Ai (SAI) is a Student Learning
              Enhancement (SLE) Tool that improves student grades while
              lightening the teacher’s load.”
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">

              <Button sx={{border:1, borderRadius: 50, height:50, alignContent: 'center', justifyContent:'center', color:'white', "&:hover": {
           borderColor:"#ffc107"
       },}} variant="outlined" href="https://apps.apple.com/us/app/spark-ai-sle/id6450753287" >
                <Icon sx={{alignContent: 'center', alignSelf: 'center', height:50, mr:1, color:'white'}}>
                  <AppleIcon/>
                </Icon>
              ...
              <Button sx={{border:1, borderRadius: 50, ml:5, height:50, alignContent: 'center', justifyContent:'center', color:'white', "&:hover": {
           borderColor:"#ffc107"
       },}} variant="outlined" href="https://play.google.com/store/apps/details?id=com.handabots.sparkai&pcampaignid=web_share" >
                <Icon sx={{alignContent: 'center', alignSelf: 'center', height:50, mr:1, color:'white'}}>
                  <AndroidIcon/>
                </Icon>
                <Typography sx={{color:'white'}}>
              ...
              {/* <Button sx={{border:1, borderRadius: 50, color:'goldenrod', ml:5}} variant="outlined" startIcon={<AndroidIcon/>} href="https://apps.apple.com/us/app/spark-ai-sle/id6450753287">
                Install android app
              </Button> */}
